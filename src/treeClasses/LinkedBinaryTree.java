...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
	...
	private Node<E> validate(Position<E> p) throws IllegalArgumentException { 
		if (!(p instanceof Node<?>)) throw new IllegalArgumentException("Position is not of righ data type."); 
	...
	public Position<E> addRoot(E e) throws IllegalStateException { 
		if (!this.isEmpty()) { throw new IllegalStateException("Non-empty tree: Can not add a root to a non-empty tree."); }
	...
	public Position<E> addLeft(Position<E> p, E e) throws IllegalArgumentException { 
		...
		if (np.getLeft() != null)  { throw new IllegalArgumentException("Given position already has left child."); }
	...
	public Position<E> addRight(Position<E> p, E e) throws IllegalArgumentException { 
		Node<E> np = validate(p); 
		if (np.getRight() != null) { throw new IllegalArgumentException("Given position already has right child."); }
	...
	{ 
		Node<E> np = validate(p); 
		if (isInternal(np)) { throw new IllegalArgumentException("Position is not an external node in the tree."); }
	...
	public E remove(Position<E> p) throws IllegalArgumentException { 
		...
		if (numChildren(ntd) == 2) { throw new IllegalArgumentException("Position to delete has two children."); }
